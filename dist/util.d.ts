...
export declare const convertPriceToDecimal: (value: string | undefined) => number;
 ...
 */
export declare function isTokenDetectionEnabledForNetwork(chainId: string): boolean;
export {};
