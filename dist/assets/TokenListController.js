...
class TokenListController extends BaseControllerV2_1.BaseController {
    ...
    constructor({ chainId, onNetworkStateChange, interval = DEFAULT_INTERVAL, cacheRefreshThreshold = DEFAULT_THRESHOLD, messenger, state, }) {
        ...
        onNetworkStateChange((networkState) => __awaiter(this, void 0, void 0, function* () {
            if (this.chainId !== networkState.provider.chainId) {
                ...
                this.update(() => {
                    var _a, _b;
                    return Object.assign(Object.assign({}, this.state), { tokenList: ((_b = (_a = this.state.tokensChainsCache) === null || _a === void 0 ? void 0 : _a[this.chainId]) === null || _b === void 0 ? void 0 : _b.data) || {} });
                });
                yield this.restart();
            }
        }));
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!util_1.isTokenDetectionEnabledForNetwork(this.chainId)) {
                return;
            }
            ...
            try {
                ...
                if (cachedTokens) {
                    ...
                    if (!tokensFromAPI) {
                        ...
                        tokenList = ((_a = tokensChainsCache === null || tokensChainsCache === void 0 ? void 0 : tokensChainsCache[this.chainId]) === null || _a === void 0 ? void 0 : _a.data) || {};
                        this.update(() => {
                            return {
                                tokenList,
                                tokensChainsCache,
                    ...
                    for (const token of uniqueTokenList) {
                        const formattedToken = Object.assign(Object.assign({}, token), { aggregators: assetsUtil_1.formatAggregatorNames(token.aggregators || []), iconUrl: assetsUtil_1.formatIconUrlWithProxy({
