...
export declare class TokensController extends BaseController<TokensConfig, TokensState> {
     ...
     */
    importTokens(tokensToImport: Token[]): Promise<void>;
    /**
     * Ignore a batch of tokens.
     *
     * @param tokensToIgnore - Array of tokens to ignore.
     */
    ignoreTokens(tokensToIgnore: Token[]): Promise<void>;
    /**
     * Adds a batch of detected tokens to the stored token list.
     *
     * @param newDetectedTokens - Array of detected tokens to be added or updated.
     */
    addDetectedTokens(newDetectedTokens: Token[]): Promise<void>;
    /**
     ...
     */
    fetchTokenMetadata(tokenAddress: string): Promise<RawToken>;
    /**
